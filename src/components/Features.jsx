        ...
        <div className="bg-white dark:bg-[#0a0a0a] py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    <h2 className="text-base/7 font-semibold text-indigo-600">Cut out unneccessary calls</h2>
                    <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 dark:text-white sm:text-5xl lg:text-balance">Find parts stocked by dealerships all around the country.</p>
                    <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-200">Discover, buy, and sell parts in one place.</p>
                </div>
