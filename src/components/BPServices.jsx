...
export default function BPServices({ user }) {
    ...
    const handleInventoryUpload = async (e) => {
        ...
        try {
            const res = await fetch("/api/profile/uploadParts", {
                method: "POST",
                body: formData,
            });
            ...
            await fetchServices(); // ✅ Refresh services from API
        ...
        <div className="flex flex-col w-full min-h-[calc(100vh-4em)] bg-gradient-to-b from-white to-blue-200 dark:from-blue-950 dark:to-background p-6">
            <div className="w-full max-w-7xl mx-auto">
                <div className="flex justify-end mb-4">
                    <label className="cursor-pointer bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
                        Upload Inventory
                        <input
                            type="file"
                            accept=".txt"
